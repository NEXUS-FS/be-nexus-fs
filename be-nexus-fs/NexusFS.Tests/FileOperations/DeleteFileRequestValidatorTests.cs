...
{
    public class DeleteFileRequestValidatorTests
    {
        private readonly DeleteFileRequestValidator _validator;

        public DeleteFileRequestValidatorTests()
        {
            _validator = new DeleteFileRequestValidator();
        }
